...
function gospel(id: string, label: string, phase: number, ranges: string[], note: string, dates: [number, number] | number | null = [27, 30]) {
  ...
  if (/AD 33/.test(records[records.length - 1].note)) records[records.length - 1].sources.push("crucifixionStudy");
}
...
gospel("gospel-annunciations", "Gabriel announces John’s birth to Zacharias", 0, ["LUK.1.5-1.25"], "Zacharias serves in the temple; Elisabeth subsequently conceives. Luke names Herod but gives no separate calendar year.", null);
gospel("gospel-annunciation-mary", "Gabriel announces Jesus’ birth to Mary", 0, ["LUK.1.26-1.38"], "The sixth month refers to Elisabeth’s pregnancy, as Luke 1:36 explains. It is not the sixth month of an independently dated calendar year.", null);
gospel("gospel-mary-elisabeth", "Mary visits Elisabeth", 0, ["LUK.1.39-1.56"], "Mary travels into the hill country and remains about three months. This is a stated visit duration, not a dated birth or a synchronized day-by-day account.", null);
gospel("gospel-joseph-dream", "Joseph receives the angel’s message in a dream", 0, ["MAT.1.18-1.25"], "Matthew describes Joseph’s response to Mary’s pregnancy and the angel’s message. The precise timing relative to Mary’s visit is not specified.", null);
...
gospel("gospel-capernaum", "Deliverance in the Capernaum synagogue", 2, ["MRK.1.21-1.28", "LUK.4.31-4.37"], "Mark and Luke place this teaching and deliverance on a sabbath at Capernaum.");
gospel("gospel-peter-house", "Peter’s mother-in-law and the evening healings", 2, ["MAT.8.14-8.17", "MRK.1.29-1.34", "LUK.4.38-4.41"], "Mark and Luke move from the synagogue to Simon’s house; many others are healed after sunset. Matthew preserves his own arrangement.");
gospel("gospel-galilee-preaching", "Prayer and preaching through Galilee", 2, ["MRK.1.35-1.39", "LUK.4.42-4.44"], "Jesus withdraws and then continues preaching. The accounts give a sequence, without a calendar date for each town.");
gospel("gospel-leper", "A leper cleansed", 2, ["MAT.8.1-8.4", "MRK.1.40-1.45", "LUK.5.12-5.16"], "The parallel accounts retain the instruction to show the priest. Their differing narrative positions do not establish the exact day of the healing.");
gospel("gospel-paralytic-levi", "The paralytic forgiven and healed", 2, ["MAT.9.1-9.8", "MRK.2.1-2.12", "LUK.5.17-5.26"], "Mark and Luke describe lowering the man through the roof; Matthew presents the same healing more briefly.");
gospel("gospel-matthew-call", "Matthew / Levi called; a meal with publicans", 2, ["MAT.9.9-9.13", "MRK.2.13-2.17", "LUK.5.27-5.32"], "The calling narratives conventionally identify Matthew and Levi. The subsequent meal and objection are distinguished from the paralytic’s healing.");
gospel("gospel-fasting-question", "The question about fasting", 2, ["MAT.9.14-9.17", "MRK.2.18-2.22", "LUK.5.33-5.39"], "The bridegroom, garment, and wine sayings answer a question about fasting. Illustrations do not become separately dated historical events.");
...
gospel("gospel-traditions", "Tradition, commandments, and defilement", 2, ["MAT.15.1-15.20", "MRK.7.1-7.23"], "Jesus answers the objection about eating with unwashen hands and explains defilement.");
gospel("gospel-syrophenician", "The Canaanite / Syrophenician woman’s daughter", 2, ["MAT.15.21-15.28", "MRK.7.24-7.30"], "Matthew calls the woman Canaanite; Mark calls her Greek and Syrophenician by nation. These descriptions are preserved in the linked accounts near Tyre and Sidon.");
gospel("gospel-deaf-man", "A deaf man with a speech impediment healed", 2, ["MRK.7.31-7.37"], "Mark names travel through Sidon toward the sea of Galilee and Decapolis. This specific healing is separate from the following feeding.");
gospel("gospel-mountain-healings", "Many healed beside the sea of Galilee", 2, ["MAT.15.29-15.31"], "Matthew describes multitudes bringing the lame, blind, dumb, and maimed. This summary is not equated with one individually named healing.");
...
gospel("gospel-transfiguration", "The transfiguration", 2, ["MAT.17.1-17.13", "MRK.9.2-9.13", "LUK.9.28-9.36"], "Matthew and Mark say after six days; Luke says about eight days after the sayings. Inclusive counting is possible, but no exact calendar date is inferred.");
gospel("gospel-boy-delivered", "The boy delivered; another Passion prediction", 2, ["MAT.17.14-17.23", "MRK.9.14-9.32", "LUK.9.37-9.45"], "Luke places the return on the next day. The healing and subsequent prediction remain a sequence, not an event on the mount itself.");
gospel("gospel-temple-tribute", "The tribute money in the fish’s mouth", 2, ["MAT.17.24-17.27"], "Matthew places this at Capernaum. The tribute question is distinct from the later question about paying Caesar.");
...
gospel("gospel-samaritan-village", "A Samaritan village refuses Jesus; sayings on following", 3, ["LUK.9.51-9.62"], "Luke begins the Jerusalem journey and records refusal of hospitality. No unnamed village or exact route is invented.");
gospel("gospel-seventy", "The seventy sent out and their return", 3, ["LUK.10.1-10.24"], "Luke supplies instructions, the return, and Jesus’s response. The elapsed length of the mission is not given.");
gospel("gospel-good-samaritan", "The lawyer’s question and the good Samaritan", 3, ["LUK.10.25-10.37"], "The dated subject is Jesus’s teaching. The traveler and Samaritan in the parable do not receive historical lives or event dates.");
gospel("gospel-martha-mary", "Jesus visits Martha and Mary", 3, ["LUK.10.38-10.42"], "Luke describes the visit without naming the village here. It is not assigned a precise date relative to John’s Bethany visits.");
...
gospel("gospel-passion-prediction-road", "The Passion foretold on the road to Jerusalem", 3, ["MAT.20.17-20.19", "MRK.10.32-10.34", "LUK.18.31-18.34"], "Jesus predicts the coming suffering and resurrection. Those events are future within this scene, not occurring during the journey.");
gospel("gospel-james-john-request", "The request for places of honour", 3, ["MAT.20.20-20.28", "MRK.10.35-10.45"], "Matthew describes the mother of Zebedee’s children approaching with her sons; Mark presents the brothers’ request. Both accounts retain the lesson on service.");
gospel("gospel-jericho", "Blind men healed at Jericho", 3, ["MAT.20.29-20.34", "MRK.10.46-10.52", "LUK.18.35-18.43"], "Matthew names two blind men; Mark names Bartimaeus. Luke’s approach wording differs from Matthew and Mark’s departure wording. The comparison does not invent a second city or force an exact sequence.");
gospel("gospel-zacchaeus", "Jesus meets Zacchaeus", 3, ["LUK.19.1-19.10"], "Luke places Zacchaeus in Jericho. This household visit is separate from the healing of the blind.");
gospel("gospel-pounds", "The parable of the pounds", 3, ["LUK.19.11-19.27"], "Jesus teaches because he is near Jerusalem and hearers expect the kingdom immediately. The nobleman’s journey belongs to the parable, not to Paul’s route or a newly dated royal journey.");
...
paul("paul-cyprus", "Barnabas and Saul sent from Antioch to Cyprus", 1, ["ACT.13.1-13.5"], "The sending church fasts and prays. The party goes through Seleucia to Salamis and preaches in the synagogues.");
paul("paul-elymas", "Elymas opposes the message at Paphos", 1, ["ACT.13.6-13.12"], "Sergius Paulus hears the message; Elymas’s opposition and blindness are a separate Paphos episode, not a stop at another Antioch.");
...
paul("paul-iconium-derbe", "Preaching and opposition at Iconium", 1, ["ACT.14.1-14.7"], "A long stay and the threat of stoning precede flight to Lystra and Derbe. The text supplies no duration for the long stay.");
paul("paul-lystra-healing", "The lame man healed at Lystra", 1, ["ACT.14.8-14.18"], "The crowd mistakes Barnabas and Paul for gods. The text records that reaction, not a biblical identification of the apostles with those deities.");
paul("paul-lystra-stoning", "Paul stoned at Lystra; onward to Derbe", 1, ["ACT.14.19-14.21"], "Paul is dragged out as supposed dead, rises, and departs the next day. Preaching at Derbe precedes the return route; verse 21 begins that return.");
...
paul("paul-philippi", "Crossing to Macedonia and Lydia’s conversion", 3, ["ACT.16.11-16.15"], "The journey passes Samothracia and Neapolis before Philippi. Lydia hears by the river on the sabbath and receives the travelers.");
paul("paul-philippi-prison", "Deliverance of the maid and imprisonment at Philippi", 3, ["ACT.16.16-16.24"], "The maid follows for many days before Paul commands the spirit to leave. Her masters’ complaint leads to beating and imprisonment.");
paul("paul-philippi-jailer", "The Philippian jailer and the prisoners’ release", 3, ["ACT.16.25-16.40"], "Prayer and the earthquake occur at midnight. The jailer’s household and the following daylight release belong to the same custody sequence, not a second visit.");
paul("paul-thessalonica-berea", "Thessalonica: preaching and opposition", 3, ["ACT.17.1-17.9"], "Paul reasons on three sabbath days after passing Amphipolis and Apollonia. This does not necessarily measure his entire stay.");
paul("paul-berea", "The Bereans search the scriptures", 3, ["ACT.17.10-17.15"], "The night departure from Thessalonica precedes ministry at Berea. Paul then leaves toward Athens while Silas and Timothy remain.");
...
paul("paul-ephesus", "Disciples at Ephesus hear about Jesus", 4, ["ACT.19.1-19.7"], "Paul meets about twelve men acquainted with John’s baptism. Their baptism and reception of the Holy Ghost are distinct from the later synagogue period.", [53, 57]);
paul("paul-tyrannus", "Three months in the synagogue; two years in the school", 4, ["ACT.19.8-19.10"], "Acts gives three months and then two years. Paul’s later three-year recollection in Acts 20:31 can be rounded or inclusive; these durations are not replaced by exact arrival and departure days.", [53, 57]);
paul("paul-sceva", "The sons of Sceva and the burning of books", 4, ["ACT.19.11-19.20"], "Luke describes special miracles, an attempted exorcism, and public repentance. This sequence does not occupy the entire Ephesian ministry window.", [53, 57]);
paul("paul-ephesus-plans", "Paul plans Jerusalem and Rome and sends helpers", 4, ["ACT.19.21-19.22"], "Timotheus and Erastus go into Macedonia while Paul stays in Asia. His intention to see Rome is not a completed trip here.", [53, 57]);
