...
gospel("gospel-samaria", "The woman of Samaria and the nobleman's son", 1, ["JHN.4.1-4.54"], "A sequence from Judaea through Samaria to Galilee, including two days with the Samaritans and the healing at Cana. These are successive episodes, not one miracle.");
...
gospel("gospel-centurion-nain", "The centurion's servant and the widow's son at Nain", 2, ["MAT.8.5-8.13", "LUK.7.1-7.17"], "Matthew and Luke describe the centurion's servant; Luke then records a distinct raising at Nain. This entry groups a narrative sequence, not a single miracle.");
...
gospel("gospel-storm-demons", "The storm stilled and deliverance across the sea", 2, ["MAT.8.18-8.34", "MRK.4.35-5.20", "LUK.8.22-8.39"], "The crossing and deliverance are successive episodes. Matthew mentions two men while Mark and Luke focus on one; the texts are retained without silently changing their details.");
gospel("gospel-jairus", "Jairus's daughter and the woman with an issue of blood", 2, ["MAT.9.18-9.38", "MRK.5.21-5.43", "LUK.8.40-8.56"], "The intertwined healings are a clear narrative parallel. Matthew continues with other healings not separately dated here.");
...
gospel("gospel-water-bread", "Walking on the sea and the bread of life discourse", 2, ["MAT.14.22-14.36", "MRK.6.45-6.56", "JHN.6.16-6.71"], "The sea crossing follows the feeding; John continues with the next day's discussion. The discourse is not claimed to appear in all three accounts.");
...
gospel("gospel-temple-debates", "Temple debates, parables, and the widow's offering", 4, ["MAT.21.23-23.39", "MRK.11.27-12.44", "LUK.20.1-21.4"], "A collection of teaching and disputes during the Jerusalem visit. Matthew 23's woes and the widow's offering are distinct sections; the parables do not supply dates for their story characters.", 30);
...
gospel("gospel-empty-tomb", "The empty tomb and resurrection announcement", 5, ["MAT.28.1-28.15", "MRK.16.1-16.8", "LUK.24.1-24.12", "JHN.20.1-20.18"], "The accounts overlap around the first day of the week and contain different visits, witnesses, and messages. This grouped account does not claim a fully settled minute-by-minute order.", 30);
gospel("gospel-appearances", "Emmaus and appearances to the disciples", 5, ["MRK.16.9-16.18", "LUK.24.13-24.49", "JHN.20.19-20.31"], "Luke gives the Emmaus journey; John distinguishes the evening appearance from the later appearance with Thomas. The KJV's Mark 16:9–20 is retained. These appearances span successive occasions.", 30);
gospel("gospel-galilee-commission", "Galilean appearances and the great commission", 5, ["MAT.28.16-28.20", "JHN.21.1-21.25"], "Matthew's mountain commission and John's lakeside appearance are distinct occasions in Galilee. They are grouped without fixing their order relative to all Jerusalem appearances.", 30);
