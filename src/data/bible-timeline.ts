...
export const TIMELINE_REVISION = "2026-09-07.1";
...
export const TIMELINE_METHOD = [
  ...
  { title: "Unknown dates and evidence", references: ["GEN.5.24", "HEB.11.5"], text: "Broken ends mean unknown birth/death; striped ranges are possible dates for one event, not its duration or probabilities. Solid bars show spans of time; point markers show single dates. Calendar dates marked c. remain approximate. An activity span does not claim a lifespan. An undated person stays available without a guessed bar. A stated age alone cannot locate someone on a calendar. Enoch's endpoint is being taken by God. Apparent overlap does not prove that two people met. BC/AD labels omit year zero; internal arithmetic includes astronomical year zero." },
...
export function buildBibleTimeline(model: SojournModel = "egypt430"): TimelineRecord[] {
  ...
  event("john-ministry", "John the Baptist's ministry begins", "gospels", 27, ["LUK.3.1", "LUK.3.2", "LUK.3.3"], "Tiberius's fifteenth year; c. AD 27–29 is shown as a dating window reflecting regnal-counting proposals, not a stated ministry duration.", ["nt"], 29, true);
  ...
  event("resurrection", "Crucifixion and resurrection", "gospels", 30, ["LUK.23.33", "LUK.24.6", "1CO.15.3", "1CO.15.4"], "AD 30 is a working proposal, with AD 33 another major candidate. The KJV supplies the events and resurrection testimony; it does not supply either AD number.", ["nt"]);
