...
export const CHRONOLOGY_REVIEWS = [
  ...
  {
    methodTitle: "The 430-year sojourn",
    references: ["GEN.12.4", "GEN.12.5", "GEN.21.5", "GEN.25.26", "GEN.47.9", "GEN.46.8", "GEN.46.11", "EXO.6.18", "EXO.6.20", "EXO.7.7", "NUM.26.59", "GEN.15.13", "ACT.7.6"],
    text: "Interval review: Abraham's 100 at Isaac's birth minus 75 at departure gives 25 years; Isaac's 60 at Jacob's birth and Jacob's 130 at entry into Egypt add 190. Thus the working departure-to-entry interval is 215 years. Adding 430 in Egypt gives 645 to the Exodus; counting 430 from departure instead leaves 215 in Egypt. A separate constraint is Kohath's presence in the entering household. On a direct Kohath–Amram–Moses father-to-son reading, even allowing Kohath's entire 133 years after entry, Amram's entire 137 before Moses's birth, and Moses's 80 before the Exodus totals only 350 years before small calendar allowances. Kohath was already alive at entry, so that allowance is deliberately generous; it still cannot accommodate 430. Jochebed's relationship and birth in Egypt in Exodus 6:20 and Numbers 26:59 add constraints. Missing generations or another same-named Amram are not established by these passages and are not inserted to make the arithmetic fit. The four hundred years of affliction in Genesis 15:13 and Acts 7:6 are retained separately; their exact starting event is not given a new date. The default remains a disclosed reading with unresolved tension, not a demonstrated reconciliation.",
  },
  {
