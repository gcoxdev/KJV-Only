...
Cohesion: 0.06
Nodes (70): ConcordanceReferencePopover, ConcordanceReferencePopoverProps, GenealogyPersonDetails(), GenealogyPersonDetailsProps, ReaderStudySidebarProps, ReaderStudyToolsContent(), ReaderStudyToolsContentProps, resetStudySearchDraft() (+62 more)

### Community 2 - "color-picker.tsx"
Cohesion: 0.06
Nodes (71): react, react, FormExample(), ColorFormat, colorFormats, ColorPickerAlphaSlider(), ColorPickerAlphaSliderProps, ColorPickerArea() (+63 more)
...
### Community 4 - "cn"
Cohesion: 0.06
Nodes (52): OldEnglishTool(), PhrasesTool(), UnitsTool(), ButtonGroup(), ButtonGroupSeparator(), ButtonGroupText(), buttonGroupVariants, ComboboxChip() (+44 more)

### Community 5 - "settings-dialog.tsx"
Cohesion: 0.07
Nodes (41): BookPickerDialogProps, CompletionCelebration(), CompletionCelebrationProps, CONFETTI_COLORS, GenealogyNode(), GenealogyRelationGrid(), GenealogyTreeDialog(), GenealogyTreeDialogProps (+33 more)

### Community 6 - "reader-panel-tree.tsx"
Cohesion: 0.07
Nodes (44): frameworks, roleItems, Example(), ExampleWrapper(), AUDIO_PLAYBACK_RATE_OPTIONS, ExistingTabTarget, LazyNotesPage, LazySearchPage (+36 more)
...
Cohesion: 0.10
Nodes (45): ReaderWordHighlight, SwapLeafState, UpdateActiveTab, usePanelInteractionController(), UsePanelInteractionControllerParams, closeLeafInTab(), collectLeafIds(), collectSameOrientationSplitIds() (+37 more)
...
### Community 10 - "kjv-reader.tsx"
Cohesion: 0.08
Nodes (38): GuidedTour(), GuidedTourProps, GuidedTourStep, TourRect, BeforeInstallPromptEvent, EMPTY_LEAF_NEIGHBORS, isDedicatedLeafViewTab(), KJVReader() (+30 more)

### Community 11 - "reader-data.ts"
Cohesion: 0.10
Nodes (34): deriveConcordanceSearchResults(), useConcordanceCrossRefsTool(), TOPIC_LETTERS, TopicsToolEntry, useTopicsTool(), isPositiveSafeInteger(), KJV_CORPUS_MANIFEST_URL, KjvCorpusAsset (+26 more)
...
Cohesion: 0.10
Nodes (36): OpenWordInStudyToolsArgs, Setter, WordStudyCoordinatorParams, books, AIDictionarySelection, findGenealogyMatches(), findMapMatches(), genealogyPeopleByName() (+28 more)

### Community 16 - "properties"
Cohesion: 0.05
Nodes (37): type, $ref, enum, type, properties, type, $ref, type (+29 more)

### Community 17 - "Largest Differences"
Cohesion: 0.05
Nodes (36): 1PE.3.1, 1TH.4.15, 2CO.5.14, 2PE.1.6, 2SA.21.1, ACT.13.48, ACT.8.39, Conclusion (+28 more)

### Community 18 - "reader-transfer.ts"
Cohesion: 0.12
...
### Community 21 - "use-panel-routing.ts"
Cohesion: 0.14
Nodes (25): createGenesisReaderTab(), createWelcomeHomeTab(), buildTargetedReaderPanelInTabState(), ReaderOpenDestination, ReaderWordHighlight, resolveTargetedReaderPanelAction(), usePanelRouting(), UsePanelRoutingParams (+17 more)

### Community 22 - "properties"
Cohesion: 0.07
Nodes (29): additionalProperties, $ref, $ref, pattern, type, type, $ref, $ref (+21 more)
...
### Community 24 - "use-reader-notes.ts"
Cohesion: 0.19
Nodes (22): useReadChapters(), useReaderController(), UseReaderControllerOptions, contextFromScope(), useReaderNotes(), UseReaderNotesArgs, useReaderPreferences(), UseReaderPreferencesOptions (+14 more)
...
### Community 27 - "reader-persistence.ts"
Cohesion: 0.12
Nodes (24): UsePanelTargetingParams, channelToLinear(), contrastRatio(), defaultHighlightColor(), hexToRgb(), normalizeHighlightColor(), readableHighlightTextColor(), relativeLuminance() (+16 more)
...
### Community 30 - "search-page.tsx"
Cohesion: 0.12
Nodes (24): ProgressPanelContent(), BookGroup, clampGroupIndices(), isChecked(), normalizeSearchMode(), sameSet(), SEARCH_HELP_ITEMS, SEARCH_MODE_LABELS (+16 more)
...
### Community 33 - "download-page.tsx"
Cohesion: 0.15
Nodes (24): buildAudioUrls(), bundleCachedPercent(), BundleDefinition, bundleDownloadPercent(), BundleId, BundleStatus, bundleStatusLabel(), DownloadPage() (+16 more)

### Community 34 - "notes-page.tsx"
Cohesion: 0.18
...
Cohesion: 0.09
Nodes (24): additionalProperties, types, required, $schema, type, required, geojson_file, types (+16 more)
...
Cohesion: 0.17
Nodes (24): bestOrderedSpanScore(), consonantSkeleton(), createTrigrams(), getSmartHighlightWords(), getSmartPhoneticCode(), hasOrderedWords(), isSmartSearchCandidate(), isSmartSearchStopWord() (+16 more)
...
### Community 45 - "reader-transfer.test.ts"
Cohesion: 0.14
Nodes (20): ImportSummaryState, usePanelTransfer(), UsePanelTransferParams, assertReaderEntryMergeLimit(), assertReaderImportFileSize(), createBookmarksExportPayload(), createNotesExportPayload(), downloadJsonFile() (+12 more)
...
### Community 48 - "report-strongs-derivation-links.mjs"
Cohesion: 0.09
...
### Community 52 - "bible.ts"
Cohesion: 0.15
Nodes (13): contextFromNoteLinkTarget(), OpenReaderTarget, ReaderWordHighlight, useWordStudyNavigation(), UseWordStudyNavigationParams, parseBooks(), normalizeStrongsCode(), OrderedKey (+5 more)
...
Cohesion: 0.12
Nodes (21): file, required, media_object_alternate, media_object_google, media_object_thumbnail, enum, credit, description (+13 more)

### Community 55 - "chapter-text-content.tsx"
Cohesion: 0.16
...
### Community 57 - "genealogy.ts"
Cohesion: 0.21
Nodes (18): useGenealogySearchTool(), canonicalizeGenealogyPersonNames(), collapseGenealogyNameVariant(), collectGenealogyCorpusData(), decodeGenealogyPayload(), decodeParent(), decodeReferences(), decodeRelation() (+10 more)

### Community 58 - "required"
Cohesion: 0.10
Nodes (20): required, class, name, score, additionalProperties, required, type, additionalProperties (+12 more)

### Community 59 - "definitions"
Cohesion: 0.10
...
Cohesion: 0.18
Nodes (12): BookChapterPicker(), BookChapterPickerProps, BookmarksToolProps, Button(), buttonVariants, Dialog(), DialogContent(), DialogDescription() (+4 more)

### Community 62 - "import_osis_to_sqlite.py"
Cohesion: 0.23
...
### Community 67 - "use-strongs-search-tool.ts"
Cohesion: 0.19
...
### Community 68 - "lib/bookmarks.ts"
Cohesion: 0.25
Nodes (16): BOOKMARK_TYPE_ORDER, bookmarkBookIndex(), bookmarkCanonicalKey(), bookmarkScopeLabel(), bookmarkScopeSummary(), compareBookmarkCanonical(), comparePoint(), normalizeBookmarkRanges() (+8 more)
...
### Community 73 - "static-page.tsx"
Cohesion: 0.16
Nodes (14): GospelStep, HowToGetSavedPage(), HowToGetSavedPageProps, ReferenceList(), renderReferenceText(), ROMANS_ROAD_STEPS, ScriptureReference, StaticPage() (+6 more)

### Community 74 - "use-reader-bookmarks.ts"
Cohesion: 0.26
Nodes (12): useReaderBookmarks(), UseReaderBookmarksArgs, createDefaultSearchPageState(), useReaderSearchPages(), normalizeRanges(), useVerseHighlights(), UseVerseHighlightsArgs, clearSingleLeafReferenceIfMissing() (+4 more)

### Community 75 - "properties"
Cohesion: 0.12
Nodes (16): type, $ref, media_object, pattern, type, $ref, additionalProperties, properties (+8 more)

### Community 76 - "build-kjv-runtime-manifest.mjs"
Cohesion: 0.12
...
### Community 77 - "definitions"
Cohesion: 0.13
Nodes (15): pattern, type, pattern, type, definitions, ancient_id, ancient_or_modern_id, image_id (+7 more)

### Community 78 - "enum"
Cohesion: 0.14
Nodes (15): enum, enum, source, enum, type, ancient, modern, nonunique_url (+7 more)

### Community 79 - "properties"
Cohesion: 0.13
Nodes (15): type, type, type, $ref, properties, best_commentaries_book_id, display_name, logos_id (+7 more)
...
### Community 82 - "build-map-json.mjs"
Cohesion: 0.30
...
### Community 90 - "Webster Source Analysis"
Cohesion: 0.17
...
### Community 91 - "welcome-home-page.tsx"
Cohesion: 0.24
Nodes (9): DailyScriptureEntry, dayOfYear(), renderVerseText(), WelcomeHomePage(), WelcomeHomePageProps, Label(), Switch(), DailyScriptureTopicsPayload (+1 more)

### Community 92 - "use-reader-corpus.ts"
Cohesion: 0.30
...
### Community 95 - "verse-search-index.ts"
Cohesion: 0.35
Nodes (9): buildVerseSearchIndex(), createSearchableVerseEntry(), extractSearchWords(), formatSearchTokenText(), formatVerseText(), isPunctuationTokenText(), matchSelectedWords(), normalizeSearchDisplayText() (+1 more)
...
### Community 106 - "why-kjv-only-page.tsx"
Cohesion: 0.20
...
### Community 111 - "Genealogy Note Reference Report"
Cohesion: 0.22
...
### Community 136 - "Security assessment"
Cohesion: 0.33
...
### Community 137 - "websters-coverage-refined-report.md"
Cohesion: 0.33
...
### Community 138 - "websters-high-value-candidates-report.md"
Cohesion: 0.33
...
### Community 146 - "Recommendation disposition"
Cohesion: 0.40
...
### Community 147 - "Structural assessment"
Cohesion: 0.40
...
### Community 148 - "Prioritized hardening roadmap"
Cohesion: 0.40
...
### Community 161 - "lonlat"
Cohesion: 0.67
Nodes (3): lonlat, pattern, type

### Community 162 - "modern_id"
Cohesion: 0.67
Nodes (3): modern_id, pattern, type

### Community 163 - "source_id"
Cohesion: 0.67
...
### Community 165 - "lonlat"
Cohesion: 0.67
Nodes (3): lonlat, pattern, type

### Community 166 - "descriptions"
Cohesion: 0.67
Nodes (3): patternProperties, type, descriptions

### Community 167 - "geojson_roles"
Cohesion: 0.67
Nodes (3): additionalProperties, type, geojson_roles

### Community 168 - "abbreviation"
Cohesion: 0.67
Nodes (3): pattern, type, abbreviation

### Community 169 - "friendly_id"
Cohesion: 0.67
...
### Community 194 - "use-verse-search-index.ts"
Cohesion: 0.48
Nodes (4): EMPTY_STATE, VerseSearchIndexState, beginPerformanceMeasure(), measureSynchronous()

## Knowledge Gaps
- **1321 isolated node(s):** `$schema`, `style`, `rsc`, `tsx`, `config` (+1316 more)
...
- **Why does `enum` connect `enum` to `id`, `enum`, `enum`, `enum`, `enum`, `properties`, `geometry`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `color-picker.tsx`, `package.json`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `react` connect `color-picker.tsx` to `plugins.tsx`, `cn`, `settings-dialog.tsx`, `sidebar.tsx`, `dependencies`?**
